...
namespace Mars.Clouds.Cmdlets
{
    ...
    public class TileStreamPosition<TTile> : TileStreamPosition where TTile : class
    {
        ...
        public void OnTileCompleted(int tileIndexX, int tileIndexY, Action<TTile>? onTileUnreferenced)
        {
        ...
        /// </remarks>
        public void OnTileCompleted(int tileIndexX, int tileIndexY, int rowReleaseConstraintInclusive, Action<TTile>? onTileUnreferenced)
        {
