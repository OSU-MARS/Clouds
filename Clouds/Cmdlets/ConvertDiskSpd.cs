...
namespace Mars.Clouds.Cmdlets
{
    ...
    public class ConvertDiskSpd : FileCmdlet
    {
        ...
        [Parameter(Mandatory = true, HelpMessage = $"Path to output .xlsx containing one row from each thread of the .xml results files indicated by -{nameof(ConvertDiskSpd.Result)}.")]
        [ValidateNotNullOrEmpty]
