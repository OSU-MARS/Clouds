...
namespace Mars.Clouds.Cmdlets
{
    ...
    public class GetTreetops : GdalCmdlet
    {
        ...
        [Parameter(HelpMessage = $"Name of band to use for surface heights in DSM raster. Default is to use '{DigitalSurfaceModel.SurfaceBandName}' if -{nameof(GetTreetops.Method)} is DsmRadius or DsmRing and '{DigitalSurfaceModel.CanopyHeightBandName}' if -{nameof(GetTreetops.Method)} is ChmRadius. Specify another band name to search other surfaces generated by Get-Dsm or use another name if -{nameof(GetTreetops.Dsm)} indicates files with different band structure.")]
