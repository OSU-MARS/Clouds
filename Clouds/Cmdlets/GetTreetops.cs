...
namespace Mars.Clouds.Cmdlets
{
    ...
    public class GetTreetops : GdalCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                for (int tileIndex = treetopSearch.GetNextTileReadIndexThreadSafe(); tileIndex < treetopSearch.MaxTileIndex; tileIndex = treetopSearch.GetNextTileReadIndexThreadSafe())
                {
                    ...
                    if (treetopSearch.TryEnsureRasterNeighborhoodRead(tileIndex, dsm, this.cancellationTokenSource) == false)
                    {
