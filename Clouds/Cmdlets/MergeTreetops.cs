...
namespace Mars.Clouds.Cmdlets
{
    ...
    public class MergeTreetops : GdalCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            VirtualRaster<Raster<byte>> classificationTiles = this.ReadVirtualRaster(cmdletName, this.Merge, Raster<byte>.CreateFromBandMetadata, this.cancellationTokenSource);
