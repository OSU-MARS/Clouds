...
namespace Mars.Clouds.Cmdlets
{
    ...
    public class GetOrthoimages : LasTilesToTilesCmdlet
    {
        ...
        protected override void ProcessRecord() 
        {
            ...
            (this.CellSize, int imageTileSizeX, int imageTileSizeY) = LasTilesToTilesCmdlet.GetTileRasterSizing(lasGrid, this.CellSize); // TODO: support -Snap
            ...
            this.WriteVerbose($"Found brightnesses of {cellsWritten:n0} pixels in {imageReadWrite.FilesRead} point cloud {(imageReadWrite.FilesRead == 1 ? "tile" : "tiles")} in {progress.Stopwatch.ToElapsedString()}: {imageReadWrite.FilesRead / progress.Stopwatch.Elapsed.TotalSeconds:0.0} tiles/s.");
            base.ProcessRecord();
        }
    }
}
