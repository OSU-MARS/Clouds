...
namespace Mars.Clouds.Cmdlets
{
    ...
    public class GetGridMetrics : LasTilesToRasterCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            VirtualRaster<Raster<float>> dtm = this.ReadVirtualRaster<Raster<float>>(cmdletName, this.Dtm, Raster<float>.CreateFromBandMetadata, this.CancellationTokenSource);
