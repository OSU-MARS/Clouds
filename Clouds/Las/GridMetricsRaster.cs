...
namespace Mars.Clouds.Las
{
    ...
    public class GridMetricsRaster : Raster
    {
        ...
        public void Reset(string filePath, LasTile lasTile)
        {
            ...
            this.AcceptedPoints.FillWithNoData();
            this.ZMax.FillWithNoData();
            this.ZMean.FillWithNoData();
            this.ZGroundMean.FillWithNoData();
            this.ZStandardDeviation.FillWithNoData();
            this.ZSkew.FillWithNoData();
            this.ZNormalizedEntropy.FillWithNoData();
            this.PZAboveZMean.FillWithNoData();
            this.PZAboveThreshold.FillWithNoData();
            this.ZQuantile05?.FillWithNoData();
            this.ZQuantile10.FillWithNoData();
            this.ZQuantile15?.FillWithNoData();
            this.ZQuantile20.FillWithNoData();
            this.ZQuantile25?.FillWithNoData();
            this.ZQuantile30.FillWithNoData();
            this.ZQuantile35?.FillWithNoData();
            this.ZQuantile40.FillWithNoData();
            this.ZQuantile45?.FillWithNoData();
            this.ZQuantile50.FillWithNoData();
            this.ZQuantile55?.FillWithNoData();
            this.ZQuantile60.FillWithNoData();
            this.ZQuantile65?.FillWithNoData();
            this.ZQuantile70.FillWithNoData();
            this.ZQuantile75?.FillWithNoData();
            this.ZQuantile80.FillWithNoData();
            this.ZQuantile85?.FillWithNoData();
            this.ZQuantile90.FillWithNoData();
            this.ZQuantile95?.FillWithNoData();
            this.IntensityFirstReturn.FillWithNoData();
            this.IntensityMean.FillWithNoData();
            this.IntensityMeanAboveMedianZ.FillWithNoData();
            this.IntensityMeanBelowMedianZ.FillWithNoData();
            this.IntensityMax.FillWithNoData();
            this.IntensityStandardDeviation.FillWithNoData();
            this.IntensitySkew.FillWithNoData();
            this.IntensityQuantile10.FillWithNoData();
            this.IntensityQuantile20.FillWithNoData();
            this.IntensityQuantile30.FillWithNoData();
            this.IntensityQuantile40.FillWithNoData();
            this.IntensityQuantile50.FillWithNoData();
            this.IntensityQuantile60.FillWithNoData();
            this.IntensityQuantile70.FillWithNoData();
            this.IntensityQuantile80.FillWithNoData();
            this.IntensityQuantile90.FillWithNoData();
            this.PFirstReturn.FillWithNoData();
            this.PSecondReturn.FillWithNoData();
            this.PThirdReturn.FillWithNoData();
            this.PFourthReturn.FillWithNoData();
            this.PFifthReturn.FillWithNoData();
            this.PGround.FillWithNoData();

            // optional bands
            this.IntensityPCumulativeZQ10?.FillWithNoData();
            this.IntensityPCumulativeZQ30?.FillWithNoData();
            this.IntensityPCumulativeZQ50?.FillWithNoData();
            this.IntensityPCumulativeZQ70?.FillWithNoData();
            this.IntensityPCumulativeZQ90?.FillWithNoData();
            this.IntensityPGround?.FillWithNoData();
            this.IntensityTotal?.FillWithNoData();
            this.IntensityKurtosis?.FillWithNoData();
            this.ZKurtosis?.FillWithNoData();

            this.ZPCumulative10?.FillWithNoData();
            this.ZPCumulative20?.FillWithNoData();
            this.ZPCumulative30?.FillWithNoData();
            this.ZPCumulative40?.FillWithNoData();
            this.ZPCumulative50?.FillWithNoData();
            this.ZPCumulative60?.FillWithNoData();
            this.ZPCumulative70?.FillWithNoData();
            this.ZPCumulative80?.FillWithNoData();
            this.ZPCumulative90?.FillWithNoData();
        }
