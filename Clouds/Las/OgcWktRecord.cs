...
namespace Mars.Clouds.Las
{
    public class OgcWktRecord : VariableLengthRecord
    {
        ...
        public override void Write(Stream stream)
        {
            ...
            {
                throw new InvalidOperationException("Serialized wkt (well known text) for coordinate system is of length " + wktBytes.Length + " which does not match the " + this.RecordLengthAfterHeader + " byte record length after header.");
            }
