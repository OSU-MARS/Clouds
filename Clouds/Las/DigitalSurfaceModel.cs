...
namespace Mars.Clouds.Las
{
    public class DigitalSurfaceModel : Raster
    {
        ...
        public void CalculateSlopeAndAspect(RasterNeighborhood8<float> dsmNeighborhood, RasterNeighborhood8<float> cmmNeighborhood, RasterBandPool dataBufferPool)
        {
            ...
            this.Bands |= DigitalSurfaceModelBands.SlopeAspect;
        }
        ...
        public override bool TryGetBand(string? name, [NotNullWhen(true)] out RasterBand? band)
        {
            ...
            else if ((this.DsmSlope != null) && String.Equals(this.DsmSlope.Name, name, StringComparison.Ordinal))
            {
                band = this.DsmSlope;
            }
            else if ((this.DsmAspect != null) && String.Equals(this.DsmAspect.Name, name, StringComparison.Ordinal))
            {
                band = this.DsmAspect;
            }
            else if ((this.CmmSlope3 != null) && String.Equals(this.CmmSlope3.Name, name, StringComparison.Ordinal))
            {
                band = this.CmmSlope3;
            }
            else if ((this.CmmAspect3 != null) && String.Equals(this.CmmAspect3.Name, name, StringComparison.Ordinal))
            {
        ...
        public void Write(string dsmPath, DigitalSurfaceModelBands bandsToWriteIfPresent, bool compress)
        {
            // primary data bands
            ...
            // slope and aspect bands
            if (((UInt32)bandsToWriteIfPresent & (UInt32)DigitalSurfaceModelBands.SlopeAspect) != 0x0)
            {
                int slopeAspectBands = (this.DsmSlope != null ? 1 : 0) + (this.DsmAspect != null ? 1 : 0) + (this.CmmSlope3 != null ? 1 : 0) + (this.CmmAspect3 != null ? 1 : 0);
                if (slopeAspectBands > 0)
                {
                    string slopeAspectTilePath = Raster.GetComponentFilePath(dsmPath, DigitalSurfaceModel.DiagnosticDirectoryZ, createDiagnosticDirectory: true);
                    ...
                    int gdalBand = 1;
                    if (((bandsToWriteIfPresent & DigitalSurfaceModelBands.DsmSlope) == DigitalSurfaceModelBands.DsmSlope) && (this.DsmSlope != null))
                    {
                        Debug.Assert(this.DsmSlope.IsNoData(RasterBand.NoDataDefaultFloat));
                        this.DsmSlope.Write(slopeAspectDataset, gdalBand);
                        ++gdalBand;
                    }
                    if (((bandsToWriteIfPresent & DigitalSurfaceModelBands.DsmAspect) == DigitalSurfaceModelBands.DsmAspect) && (this.DsmAspect != null))
                    {
                        Debug.Assert(this.DsmAspect.IsNoData(RasterBand.NoDataDefaultFloat));
                        this.DsmAspect.Write(slopeAspectDataset, gdalBand);
                        ++gdalBand;
                    }
                    if (((bandsToWriteIfPresent & DigitalSurfaceModelBands.CmmSlope3) == DigitalSurfaceModelBands.CmmSlope3) && (this.CmmSlope3 != null))
                    {
                        Debug.Assert(this.CmmSlope3.IsNoData(RasterBand.NoDataDefaultFloat));
                        this.CmmSlope3.Write(slopeAspectDataset, gdalBand);
                        ++gdalBand;
                    }
                    if (((bandsToWriteIfPresent & DigitalSurfaceModelBands.CmmAspect3) == DigitalSurfaceModelBands.CmmAspect3) && (this.CmmAspect3 != null))
                    {
            ...
            if (((UInt32)bandsToWriteIfPresent & (UInt32)DigitalSurfaceModelBands.DiagnosticZ) != 0x0)
            {
                int zDiagnosticBands = (this.Subsurface != null ? 1 : 0) + (this.AerialMean != null ? 1 : 0) + (this.GroundMean != null ? 1 : 0);
                if (zDiagnosticBands > 0)
                {
                    string zTilePath = Raster.GetComponentFilePath(dsmPath, DigitalSurfaceModel.DiagnosticDirectoryZ, createDiagnosticDirectory: true);

                    using Dataset zDataset = this.CreateGdalRasterAndSetFilePath(zTilePath, zDiagnosticBands, DataType.GDT_Float32, compress);
                    int gdalBand = 1;
                    if (((bandsToWriteIfPresent & DigitalSurfaceModelBands.Subsurface) == DigitalSurfaceModelBands.Subsurface) && (this.Subsurface != null))
                    {
                        Debug.Assert(this.Subsurface.IsNoData(RasterBand.NoDataDefaultFloat));
                        this.Subsurface.Write(zDataset, gdalBand);
                        ++gdalBand;
                    }
                    if (((bandsToWriteIfPresent & DigitalSurfaceModelBands.AerialMean) == DigitalSurfaceModelBands.AerialMean) && (this.AerialMean != null))
                    {
                        Debug.Assert(this.AerialMean.IsNoData(RasterBand.NoDataDefaultFloat));
                        this.AerialMean.Write(zDataset, gdalBand);
                        ++gdalBand;
                    }
                    if (((bandsToWriteIfPresent & DigitalSurfaceModelBands.GroundMean) == DigitalSurfaceModelBands.GroundMean) && (this.GroundMean != null))
                    {
            ...
            if (((UInt32)bandsToWriteIfPresent & (UInt32)DigitalSurfaceModelBands.PointCounts) != 0x0)
            {
                ...
                {
                    string pointCountTilePath = Raster.GetComponentFilePath(dsmPath, DigitalSurfaceModel.DiagnosticDirectoryPointCounts, createDiagnosticDirectory: true);
            ...
            {
                string returnNumberTilePath = Raster.GetComponentFilePath(dsmPath, DigitalSurfaceModel.DiagnosticDirectoryReturnNumber, createDiagnosticDirectory: true);
            ...
            {
                string sourceIDtilePath = Raster.GetComponentFilePath(dsmPath, DigitalSurfaceModel.DiagnosticDirectorySourceID, createDiagnosticDirectory: true);
