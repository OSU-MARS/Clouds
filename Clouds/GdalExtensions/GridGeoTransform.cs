...
namespace Mars.Clouds.GdalExtensions
{
    public class GridGeoTransform
    {
        ...
        public void Copy(GridGeoTransform other, int subsamplingRatio)
        {
            this.OriginX = other.OriginX;
            this.OriginY = other.OriginY;
            this.CellHeight = subsamplingRatio * other.CellHeight;
            this.CellWidth = subsamplingRatio * other.CellWidth;
            this.RowRotation = other.RowRotation;
            this.ColumnRotation = other.ColumnRotation;
        }
