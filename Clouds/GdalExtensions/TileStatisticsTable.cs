...
{
    public class TileStatisticsTable : XlsxSerializable
    {
        ...
        public void Write(Stream stream)
        {
            ...
            // header row
            Row headerRow = XlsxSerializable.CreateHeaderRow("tile", "band", "cells", "noData", "minimum", "mean", "maximum", "standardDeviation");
