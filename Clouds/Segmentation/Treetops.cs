...
namespace Mars.Clouds.Segmentation
{
    public class Treetops
    {
        ...
        public void GetClassCounts(VirtualRasterNeighborhood8<byte> classificationNeighborhood)
        {
            ...
            {
                (int treetopXindex, int treetopYindex) = classificationNeighborhood.Center.Transform.GetCellIndices(this.X[treetopIndex], this.Y[treetopIndex]);
                ...
                Debug.Assert((treetopXindex >= -1) && (treetopXindex <= classificationNeighborhood.Center.XSize) && (treetopYindex >= -1) && (treetopYindex <= classificationNeighborhood.Center.YSize), "Treetop at (" + this.X[treetopIndex] + ", " + this.Y[treetopIndex] + ") is not located over center tile (extents " + classificationNeighborhood.Center.Transform.OriginX + ", " + classificationNeighborhood.Center.Transform.OriginX + classificationNeighborhood.Center.XSize * classificationNeighborhood.Center.Transform.CellWidth + ", " + classificationNeighborhood.Center.Transform.OriginY + classificationNeighborhood.Center.YSize * classificationNeighborhood.Center.Transform.CellHeight + ", " + classificationNeighborhood.Center.Transform.OriginY + ").");
