...
namespace Mars.Clouds.Segmentation
{
    public class TreeCrownCostField
    {
        ...
        public int DsmMaximumX { get; private set; }
        public int DsmMaximumY { get; private set; }
        public int DsmMinimumX { get; private set; }
        public int DsmMinimumY { get; private set; }
        ...
        /// </remarks>
        public void MoveToTreetopAndRecalculate(int dsmTreetopIndexX, int dsmTreetopIndexY, int treeID, float treetopZ, TreeCrownSegmentationState segmentationState)
        {
            ...
            if (dsm.TryGetValue(dsmTreetopIndexX, dsmTreetopIndexY, out float dsmTreetopZ) == false)
            {
                ...
                throw new NotSupportedException("Digital surface model lacks a value for treetop " + treeID + " at (" + dsmTreetopIndexX + ", " + dsmTreetopIndexY + ").");
            }
            ...
            Debug.Assert((0 <= minimumIndexX) && (minimumIndexX < TreeCrownCostField.CapacityXY) &&
                         (0 <= minimumIndexY) && (minimumIndexY < TreeCrownCostField.CapacityXY));
